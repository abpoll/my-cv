...
\hypersetup{colorlinks, breaklinks, urlcolor=DartAccent, linkcolor=DartAccent}
...
\noindent{
  ...
  \begin{tabular}{L{0.5\textwidth}R{0.5\textwidth}}
    University of Iowa       & \texttt{\href{mailto:adam-pollack@uiowa.edu}{adam-pollack@uiowa.edu}} \, \faEnvelope                                                                                  \\
    School of Earth, Environment, and Sustainability       & \texttt{\href{https://abpoll.github.io/}{https://abpoll.github.io/}} \, \faGlobe                                                                                                \\
    307 Jessup Hall    & \texttt{\href{https://github.com/abpoll}{abpoll}} \, \faGithub                                                                      \\
    Iowa City, IA 52242 & \texttt{\href{https://scholar.google.com/citations?user=mnigw6AAAAAJ}{Adam Pollack}} \, \aiGoogleScholar \\
  \end{tabular}
}
...
\begin{itemize}[label={}]
  ...
  \item \textbf{University of Iowa}
        ...
        \textit{Assistant Professor}, School of Earth, Environment, and Sustainability, 2026--present.
        
        
        
  \item \textbf{Dartmouth College}
        
        \textit{Lecturer}, Thayer School of Engineering, 2025--2026.
        
        
        \textit{Research Scientist}, Thayer School of Engineering, 2024--2026.
...
\begin{itemize}[label={}]
  ...
  \item \textbf{Co-Principal Investigator}, \enquote{Development of urban flood forecasting services in the Caribbean and in Comoros}.  PI: Humberto Vergarra. {World Meteorological Orgainzation}, \$1,201,553. 2026--2026.
...
\begin{itemize}[label={}]
  ...
  \item \enquote{\textbf{Quantifying and managing climate risks and inequitable outcomes}}, Joing Iowa Flood Center/Civil and Environmental Engineering Seminar,  \textit{University of Iowa}. Iowa City, Iowa, 2026.
  
  \item \enquote{\textbf{Research insights for Pennsylvania’s proposed flood disclosure law}}, Pennsylvania Natural Hazards Legal and Planning Aspects Workshop,  \textit{Pennsylvania Emergency Management Agency}. Harrisburg, Pennsylvania, 2025.
...
\begin{itemize}[label={}]
  ...
  \item \href{https://heatmap.news/adaptation/carbonplan-fire-risk}{This New Wildfire Risk Model Has No Secrets}, \textit{Emily Pontecorvo}, \textbf{Heatmap News}, 2026-02-10.
        
  \item \href{https://www.rutgers.edu/news/scientists-recommend-steps-strengthen-transparency-climate-risk-research}{Scientists Recommend Steps to Strengthen Transparency of Climate Risk Research}, \textit{Greg Bruno}, \textbf{Rutgers Today}, 2026-01-28.
        
  \item \href{https://engineering.dartmouth.edu/news/researchers-call-for-more-transparency-in-climate-risk-science}{Dartmouth Researchers Call for More Transparency in Climate-Risk Science}, \textit{Catha Mayor}, \textbf{Dartmouth News}, 2026-01-16.
        
  \item \href{https://www.bloomberg.com/news/articles/2025-12-09/real-estate-climate-risk-score-debate-reveals-limits-of-flood-fire-modeling}{Zillow Deleting Home Climate Risk Scores Reveals Limits of Flood, Fire Data}, \textit{Eric Roston}, \textbf{Bloomberg}, 2025-12-09.
...
\item Julian Gutierrez. Thayer School of Engineering. Research Co-Mentor (with Klaus Keller). 2023--2026.  
...
\begin{itemize}[label={}]
  ...
  \item \textbf{University of Iowa}
        ...
        Environmental Justice. Primary Instructor. Spring 2026.
        
        School of Earth, Environment, and Sustainability Foundations. Co-Instructor. Spring 2026.
...
\begin{itemize}[label={}]
  ...
  \item \textbf{Ad Hoc Reviewer: Human-Environment and Geographical Sciences Program}, National Science Foundation. 2026.
  
  \item \textbf{Program Committee: Annual Conference of the Society of Decision Making Under Deep Uncertainty}, Society of Decision Making Under Deep Uncertainty. 2026.
  
  \item \textbf{Session Co-convener: Advances in Urban Flood Risk Assessment and Adaptation}, 2025 American Geophysical Union Fall Meeting (New Orleans, LA). 2025.
