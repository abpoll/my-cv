...
\definecolor{DartGreen}{HTML}{FFCD00} % official Iowa Yellow color -- use for headers
\definecolor{DartAccent}{HTML}{00558C} % official Iowa accent -- use for urls
\definecolor{BlueAccent}{HTML}{00664F} % background color, green accent -- do not use for anything else
\definecolor{BlueAccent}{HTML}{00664F} % backup color 
...
\begin{itemize}[label={}]
  ...
  \item \textbf{University of Iowa}
        ...
        \textit{Adjunct Assistant Professor}, School of Earth, Environment, and Sustainability, 2025--2026.
...
\begin{itemize}[label={}]
  ...
  \item \href{https://engineering.dartmouth.edu/news/researchers-call-for-more-transparency-in-climate-risk-science}{Dartmouth Researchers Call for More Transparency in Climate-Risk Science}, \textit{Catha Mayor}, \textbf{}, 2026-01-16.
...
\begin{itemize}[label={}]
  ...
  \item \textbf{N/A}
        ...
        Decision analysis for wicked climate problems. Piloted graduate-level course with 4 PhD students. Fall 2025.
